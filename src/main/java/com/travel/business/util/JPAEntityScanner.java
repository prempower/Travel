package com.travel.business.util;
...
/**
 * This JPAEntityScanner will scan for all JPA persistence entities defined in the
 * spring-config.xml. One or more packages that contain the JPA entities can be listed
